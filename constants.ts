...
const initialSessions: Session[] = [
    ...
    { id: 's3', title: 'Regulación de IA en el Derecho', speakers: [SPEAKERS[2]], trackId: 'etica', room: 'Sala Conferencias 3', day: DAYS[0], time: '11:00', status: SessionStatus.PROPOSED },
    { id: 's4', title: 'Casos de Uso de IA Legal', speakers: [SPEAKERS[3]], trackId: 'practica', room: 'Sala Conferencias 1', day: DAYS[1], time: '9:00', status: SessionStatus.ANNOUNCED, zoomLink: 'https://zoom.us/j/777888999' },
    ...
    { id: 's7', title: 'Blockchain en el Sistema Legal', speakers: [SPEAKERS[5]], trackId: 'futuro', room: 'Sala Conferencias 3', day: DAYS[0], time: '14:00', status: SessionStatus.CANCELLED },
    ...
    { id: 's9', title: 'Análisis Predictivo en Litigios', speakers: [SPEAKERS[4]], trackId: 'legal-ia', room: 'Sala Conferencias 5', day: DAYS[0], time: '10:00', status: SessionStatus.ANNOUNCED, zoomLink: 'https://zoom.us/j/151617181' },
    ...
    { id: 's14', title: 'Cierre y Reflexiones', speakers: [SPEAKERS[1], SPEAKERS[2]], trackId: 'futuro', room: 'Sala Principal', day: DAYS[4], time: '20:00', status: SessionStatus.ANNOUNCED, zoomLink: 'https://zoom.us/j/232425262' },
];
